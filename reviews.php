...
// change the value of $dbuser and $dbpass to your username and password
	...
	$table = $_POST['table'];
	$query = "SELECT Bars.bar_id, Bars.name, Bars.theme, bar_review.rate, bar_review.description 
	FROM Bars INNER JOIN bar_review ON Bars.bar_id = bar_review.bar_id";
